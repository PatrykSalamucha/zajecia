...
public class Animal implements Sellable {
    ...
    public Animal(String name, boolean canFly, Species species) {
        ...
        this.canFly = canFly;
        this.SPECIES = species;
        this.weight = setDefaultWeightBySpecies();
    }
    ...
    private double setDefaultWeightBySpecies(){
        switch (SPECIES){
            case CATS:
    ...
    public void sell(Human seller, Human buyer, double price) {
        if(seller.getPet() == null || seller.getPet() != this)
            throw new IllegalStateException("Seller doesn't have this pet");
        ...
        System.out.printf("%s sprzedał zwierzę użytkownikowi %s za %f zł.", seller.getFullname(), buyer.getFullname(), price);
